...
import org.firstinspires.ftc.teamcode.commands.TelePathSpecimenCommand;
import org.firstinspires.ftc.teamcode.commands.TeleSlowDriveCommand;
import org.firstinspires.ftc.teamcode.commands.VisionCommands.LimelightSpecimenCommand;
...
@TeleOp
public class LimelightTest extends Storage {
    ...
    public void initialize() {
        ...
        follower.setStartingPose(new Pose(30.5, -56, PI/2));
        follower.setPose(new Pose(30.5, -50, PI/2));
        ...
        autoDriveSubsystem = new AutoDriveSubsystem(follower, telemetry, new Pose(30.5, -56, PI/2));
...
//                }));
        driverOp.getGamepadButton(GamepadKeys.Button.X)
                .whileHeld(new TelePathSpecimenCommand(autoDriveSubsystem, follower.getPose(), follower,limelightSubsystem));
...
//
        limelightSubsystem.setDefaultCommand(new LimelightSpecimenCommand(limelightSubsystem, follower));

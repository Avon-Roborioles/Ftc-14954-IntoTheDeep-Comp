...
public class AutoCollectSample extends CommandBase {
    ...
    Timing.Timer totalTime = new Timing.Timer(6, TimeUnit.SECONDS);

    // This command will acquire samples and either eject them or accept them based on color
    public AutoCollectSample(IntakeSubsystem subsystem, WristSubsystem wrist) {
    ...
    public boolean isFinished() {
        return validSample || totalTime.done();
    }
}

...
import static org.firstinspires.ftc.teamcode.OpModes.Auto.PoseList.LBar;
...
import static org.firstinspires.ftc.teamcode.OpModes.Auto.PoseList.LStartBar;
...
public class RedLeft3_1 extends AutoBase{
    ...
    public void makeAuto() {
        ...
        autoDriveSubsystem = new AutoDriveSubsystem(follower, mTelemetry, LStartBar);
    }

    @Override
    public void buildPaths() {
        toScorePreload = new Path(new BezierCurve(new Point(LStartBar), new Point(LBar)));
        toScorePreload.setLinearHeadingInterpolation(LStartBar.getHeading(), LBar.getHeading());
        toScorePreload.setPathEndTimeoutConstraint(2000);

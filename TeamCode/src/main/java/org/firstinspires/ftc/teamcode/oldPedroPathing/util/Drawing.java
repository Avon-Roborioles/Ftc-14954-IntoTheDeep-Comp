package org.firstinspires.ftc.teamcode.oldPedroPathing.util;
...
public class Drawing {
    ...
    public static void drawDebug(Follower follower) {
        if (follower.getCurrentPath() != null) {
            ...
            drawRobot(new Pose(closestPoint.getX()-72, closestPoint.getY()-72, follower.getCurrentPath().getHeadingGoal(follower.getCurrentPath().getClosestPointTValue())), "#3F51B5");
        }

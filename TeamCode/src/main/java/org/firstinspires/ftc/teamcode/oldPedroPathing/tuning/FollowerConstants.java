...
import org.firstinspires.ftc.teamcode.oldPedroPathing.util.CustomFilteredPIDFCoefficients;
import org.firstinspires.ftc.teamcode.oldPedroPathing.util.CustomPIDFCoefficients;
import org.firstinspires.ftc.teamcode.oldPedroPathing.util.KalmanFilterParameters;
...
public class FollowerConstants {
    ...
    private static double xMovement = 62.8461;
    private static double yMovement = 48.1741;
    ...
    public static double forwardZeroPowerAcceleration = -31.0466;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -66.0001;
